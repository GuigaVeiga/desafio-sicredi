...
public class SwaggerConfig {
    ...
    public static final String NOME_DESAFIO_SICREDI_SERVICE = "desafio-sicredi-service";
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title(NOME_DESAFIO_SICREDI_SERVICE)
                .description(DESCRICAO_SERVICO)
                .version(VERSAO_SERVICO)
                .contact(new Contact("Guilherme Siqueira", "https://www.linkedin.com/in/guilherme-siqueira-pecanha-da-veiga/", "siqguilherme@gmail.com"))
                .build();
